...
public static class BurstClassInfo
{
	...
	internal unsafe delegate int Index_00004CB1_0024PostfixBurstDelegate(lua_State* L);

	internal static class Index_00004CB1_0024BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<Index_00004CB1_0024PostfixBurstDelegate>(Index).Value;
			}
			P_0 = Pointer;
		}
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal unsafe delegate int NewIndex_00004CB2_0024PostfixBurstDelegate(lua_State* L);

	internal static class NewIndex_00004CB2_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<NewIndex_00004CB2_0024PostfixBurstDelegate>(NewIndex).Value;
			}
			P_0 = Pointer;
		}
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal unsafe delegate int NameCall_00004CB3_0024PostfixBurstDelegate(lua_State* L);

	internal static class NameCall_00004CB3_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<NameCall_00004CB3_0024PostfixBurstDelegate>(NameCall).Value;
			}
			P_0 = Pointer;
		}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(Index_00004CB1_0024PostfixBurstDelegate))]
	public unsafe static int Index(lua_State* L)
	{
		return Index_00004CB1_0024BurstDirectCall.Invoke(L);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(NewIndex_00004CB2_0024PostfixBurstDelegate))]
	public unsafe static int NewIndex(lua_State* L)
	{
		return NewIndex_00004CB2_0024BurstDirectCall.Invoke(L);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(NameCall_00004CB3_0024PostfixBurstDelegate))]
	public unsafe static int NameCall(lua_State* L)
	{
		return NameCall_00004CB3_0024BurstDirectCall.Invoke(L);
	}
