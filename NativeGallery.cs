	...
	private static MonoScriptData Get()
	{
		return new MonoScriptData
		{
			FilePathsData = new byte[81]
			{
				...
				101, 71, 97, 108, 108, 101, 114, 121, 66, 114,
				105, 100, 103, 101, 92, 78, 97, 116, 105, 118,
				101, 71, 97, 108, 108, 101, 114, 121, 46, 99,
				115
			},
			TypesData = new byte[42]
			{
				0, 0, 0, 0, 37, 76, 105, 118, 46, 78,
				97, 116, 105, 118, 101, 71, 97, 108, 108, 101,
				114, 121, 66, 114, 105, 100, 103, 101, 124, 78,
				97, 116, 105, 118, 101, 71, 97, 108, 108, 101,
				114, 121
			},
			TotalFiles = 1,
...
public static class NativeGallery
{
	...
	private static async Task<Permission> SaveToGallery(byte[] mediaBytes, string album, string filename, MediaType mediaType, MediaSaveCallback callback)
	{
		...
		if (result == Permission.Granted)
		{
			...
			{
				UnityEngine.Debug.LogWarning("LCK 'filename' doesn't have an extension, this might result in unexpected behaviour!");
			}
