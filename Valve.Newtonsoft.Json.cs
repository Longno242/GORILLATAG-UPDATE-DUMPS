	...
	public abstract class JsonWriter : IDisposable
	{
		...
		internal static State[][] BuildStateArray()
		{
			...
			foreach (JsonToken value in EnumUtils.GetValues(typeof(JsonToken)))
			{
				...
				{
					if ((uint)(value - 7) <= 5u || (uint)(value - 16) <= 1u)
					{
						list.Add(item2);
					}
					else
...
namespace Valve.Newtonsoft.Json.Serialization
{
	...
	internal struct ResolverContractKey(Type resolverType, Type contractType) : IEquatable<ResolverContractKey>
	{
	...
	public class DefaultContractResolver : IContractResolver
	{
		...
		protected virtual JsonDictionaryContract CreateDictionaryContract(Type objectType)
		{
			...
			if ((object)attribute?.NamingStrategyType != null)
			{
		...
		private void SetPropertySettingsFromAttributes(JsonProperty property, object attributeProvider, string name, Type declaringType, MemberSerialization memberSerialization, out bool allowNonPublicAccess)
		{
			...
			NamingStrategy namingStrategy = (((object)attribute?.NamingStrategyType != null) ? JsonTypeReflector.CreateNamingStrategyInstance(attribute.NamingStrategyType, attribute.NamingStrategyParameters) : (((object)attribute3?.NamingStrategyType == null) ? NamingStrategy : JsonTypeReflector.GetContainerNamingStrategy(attribute3)));
	...
	internal static class JsonTypeReflector
	{
		...
		public static NamingStrategy GetContainerNamingStrategy(JsonContainerAttribute containerAttribute)
		{
			...
			{
				if ((object)containerAttribute.NamingStrategyType == null)
				{
					return null;
				}
